...
- **Planned surfaces:** Console I/O views, file manager affordances, settings, tools, and CLI wiring exist as stubs so future work can slot into the existing feature folders.
