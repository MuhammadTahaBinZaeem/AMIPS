...
The legacy simulator defines 139 unique instruction mnemonics in `InstructionSet.java`, and `mars-next` now decodes all 139. The comparison below was produced by collecting mnemonic names from `legacy/mars/mips/instructions/InstructionSet.java` and `mars-next/src/core/cpu/Instructions/index.ts` and then diffing the two sets.
...
- Arithmetic and logic: `add`, `addu`, `sub`, `subu`, `and`, `or`, `nor`, `slt`, `sltu`, `xor`, `mul`, `madd`, `maddu`, `mult`, `multu`
- HI/LO register operations: `mfhi`, `mflo`, `mthi`, `mtlo`, `msub`, `msubu`
- Immediate arithmetic and logic: `addi`, `addiu`, `andi`, `ori`, `xori`, `lui`, `slti`, `sltiu`
- Shifts: `sll`, `sllv`, `srl`, `srlv`, `sra`, `srav`
- Byte/halfword/word memory access: `lb`, `lbu`, `lh`, `lhu`, `ll`, `lwl`, `lwr`, `lw`, `sb`, `sh`, `sw`, `swl`, `swr`, `sc`
...
- Floating point conversions, moves, and rounding to word: `ceil.w.s`, `ceil.w.d`, `cvt.d.s`, `cvt.d.w`, `cvt.s.d`, `cvt.s.w`, `cvt.w.d`, `cvt.w.s`, `floor.w.d`, `floor.w.s`, `mov.d`, `mov.s`, `round.w.d`, `round.w.s`, `trunc.w.d`, `trunc.w.s`
...
- Trap instructions: `teq`, `teqi`, `tge`, `tgei`, `tgeiu`, `tgeu`, `tlt`, `tlti`, `tltiu`, `tltu`, `tne`, `tnei`

## Missing instruction mnemonics

None. `mars-next` now implements every mnemonic defined in the legacy simulator.
